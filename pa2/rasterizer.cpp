...
{   
    ...
    Eigen::Vector3f aq = q-a;
    Eigen::Vector3f bq = q-b;
    Eigen::Vector3f cq = q-c;

    Eigen::Vector3f r0 = ab.cross(aq);
    Eigen::Vector3f r1 = bc.cross(bq);
    Eigen::Vector3f r2 = ca.cross(cq);
